...
try{
    ...
    if ($stmt->rowCount() != 0) {
        ...
        foreach ($stmt as $row){
            ...
            <th scope='row' id='OID_$OID'>$OID</th>
            ...
            // modal
            $modal = "<div class='modal' id='$OID-details' data-backdrop='static' tabindex='-1' role='dialog' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
